...
/**
 *  WorkerDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class WorkerDTO implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected it.fenealgestweb.www.SubscriptionDTO localSubscription;
     ...
     */
    protected it.fenealgestweb.www.ArrayOfSubscriptionDTO localSubscriptions;
     ...
     * field for Documents
     */
    protected it.fenealgestweb.www.ArrayOfDocumentDTO localDocuments;
     ...
     * @return it.fenealgestweb.www.SubscriptionDTO
     */
    public it.fenealgestweb.www.SubscriptionDTO getSubscription() {
     ...
     */
    public void setSubscription(it.fenealgestweb.www.SubscriptionDTO param) {
    ...
    /**
     * Auto generated getter method
     * @return it.fenealgestweb.www.ArrayOfSubscriptionDTO
     */
    public it.fenealgestweb.www.ArrayOfSubscriptionDTO getSubscriptions() {
    ...
    public void setSubscriptions(
        it.fenealgestweb.www.ArrayOfSubscriptionDTO param) {
    ...
    /**
     * Auto generated getter method
     * @return it.fenealgestweb.www.ArrayOfDocumentDTO
     */
    public it.fenealgestweb.www.ArrayOfDocumentDTO getDocuments() {
     ...
     */
    public void setDocuments(it.fenealgestweb.www.ArrayOfDocumentDTO param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localRowNumber != java.lang.Integer.MIN_VALUE) {
            writeAttribute("www.fenealgestweb.it", "RowNumber",
        ...
        if (true) {
            writeAttribute("www.fenealgestweb.it", "IsValid",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (true) {
            writeAttribute("www.fenealgestweb.it", "ExistBirthPlace",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (true) {
            writeAttribute("www.fenealgestweb.it", "ExistLivingPlace",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localNationality != null) {
            writeAttribute("www.fenealgestweb.it", "Nationality",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localNationality), xmlWriter);
        }

        if (localLastModifer != null) {
            writeAttribute("www.fenealgestweb.it", "LastModifer",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localLastModifer), xmlWriter);
        }

        if (localErrors != null) {
            writeAttribute("www.fenealgestweb.it", "Errors",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localErrors), xmlWriter);
        }

        if (localName != null) {
            writeAttribute("www.fenealgestweb.it", "Name",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localName), xmlWriter);
        }

        if (localSurname != null) {
            writeAttribute("www.fenealgestweb.it", "Surname",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localBirthDate != null) {
            writeAttribute("www.fenealgestweb.it", "BirthDate",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localLastUpdate != null) {
            writeAttribute("www.fenealgestweb.it", "LastUpdate",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localBirthPlace != null) {
            writeAttribute("www.fenealgestweb.it", "BirthPlace",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localBirthPlace), xmlWriter);
        }

        if (localCurrentAzienda != null) {
            writeAttribute("www.fenealgestweb.it", "CurrentAzienda",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localCurrentAzienda), xmlWriter);
        }

        if (localIscrittoA != null) {
            writeAttribute("www.fenealgestweb.it", "IscrittoA",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localIscrittoA), xmlWriter);
        }

        if (localLiberoAl != null) {
            writeAttribute("www.fenealgestweb.it", "LiberoAl",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localLivingPlace != null) {
            writeAttribute("www.fenealgestweb.it", "LivingPlace",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localLivingPlace), xmlWriter);
        }

        if (localAddress != null) {
            writeAttribute("www.fenealgestweb.it", "Address",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localAddress), xmlWriter);
        }

        if (localCap != null) {
            writeAttribute("www.fenealgestweb.it", "Cap",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localCap), xmlWriter);
        }

        if (localPhone != null) {
            writeAttribute("www.fenealgestweb.it", "Phone",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localSubscriptionTracker) {
            ...
            localSubscription.serialize(new javax.xml.namespace.QName(
                    "www.fenealgestweb.it", "Subscription"), xmlWriter);
        }
        ...
        if (localSubscriptionsTracker) {
            ...
            localSubscriptions.serialize(new javax.xml.namespace.QName(
                    "www.fenealgestweb.it", "Subscriptions"), xmlWriter);
        }
        ...
        if (localDocumentsTracker) {
            ...
            localDocuments.serialize(new javax.xml.namespace.QName(
                    "www.fenealgestweb.it", "Documents"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static WorkerDTO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            WorkerDTO object = new WorkerDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WorkerDTO".equals(type)) {
                            ...
                            return (WorkerDTO) it.fenealgestweb.www.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribRowNumber = reader.getAttributeValue("www.fenealgestweb.it",
                        "RowNumber");
                ...
                java.lang.String tempAttribIsValid = reader.getAttributeValue("www.fenealgestweb.it",
                        "IsValid");
                ...
                java.lang.String tempAttribExistBirthPlace = reader.getAttributeValue("www.fenealgestweb.it",
                        "ExistBirthPlace");
                ...
                java.lang.String tempAttribExistLivingPlace = reader.getAttributeValue("www.fenealgestweb.it",
                        "ExistLivingPlace");
                ...
                java.lang.String tempAttribNationality = reader.getAttributeValue("www.fenealgestweb.it",
                        "Nationality");
                ...
                java.lang.String tempAttribLastModifer = reader.getAttributeValue("www.fenealgestweb.it",
                        "LastModifer");
                ...
                java.lang.String tempAttribErrors = reader.getAttributeValue("www.fenealgestweb.it",
                        "Errors");
                ...
                java.lang.String tempAttribName = reader.getAttributeValue("www.fenealgestweb.it",
                        "Name");
                ...
                java.lang.String tempAttribSurname = reader.getAttributeValue("www.fenealgestweb.it",
                        "Surname");
                ...
                java.lang.String tempAttribBirthDate = reader.getAttributeValue("www.fenealgestweb.it",
                        "BirthDate");
                ...
                java.lang.String tempAttribLastUpdate = reader.getAttributeValue("www.fenealgestweb.it",
                        "LastUpdate");
                ...
                java.lang.String tempAttribBirthPlace = reader.getAttributeValue("www.fenealgestweb.it",
                        "BirthPlace");
                ...
                java.lang.String tempAttribCurrentAzienda = reader.getAttributeValue("www.fenealgestweb.it",
                        "CurrentAzienda");
                ...
                java.lang.String tempAttribIscrittoA = reader.getAttributeValue("www.fenealgestweb.it",
                        "IscrittoA");
                ...
                java.lang.String tempAttribLiberoAl = reader.getAttributeValue("www.fenealgestweb.it",
                        "LiberoAl");
                ...
                java.lang.String tempAttribLivingPlace = reader.getAttributeValue("www.fenealgestweb.it",
                        "LivingPlace");
                ...
                java.lang.String tempAttribAddress = reader.getAttributeValue("www.fenealgestweb.it",
                        "Address");
                ...
                java.lang.String tempAttribCap = reader.getAttributeValue("www.fenealgestweb.it",
                        "Cap");
                ...
                java.lang.String tempAttribPhone = reader.getAttributeValue("www.fenealgestweb.it",
                        "Phone");
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "Subscription").equals(
                            reader.getName())) {
                    object.setSubscription(it.fenealgestweb.www.SubscriptionDTO.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("www.fenealgestweb.it",
                            "Subscriptions").equals(reader.getName())) ||
                        new javax.xml.namespace.QName("", "Subscriptions").equals(
                            reader.getName())) {
                    object.setSubscriptions(it.fenealgestweb.www.ArrayOfSubscriptionDTO.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "Documents").equals(
                            reader.getName())) {
                    object.setDocuments(it.fenealgestweb.www.ArrayOfDocumentDTO.Factory.parse(
                            reader));
