...
/**
 *  TraceUsage bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TraceUsage implements org.apache.axis2.databinding.ADBBean {
     ...
     *   in the serialized XML
     */
    protected boolean localAppTracker = false;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TraceUsage", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TraceUsage", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TraceUsage parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TraceUsage object = new TraceUsage();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TraceUsage".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TraceUsage) it.fenealgestweb.www.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.fenealgestweb.it/", "app").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "app").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
