...
/**
 *  SubscriptionDTOE bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SubscriptionDTOE implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected it.fenealgestweb.www.FenealwebSubscriptionDTODataE localFenealwebSubscriptionDTOData;
     ...
     * This was an Attribute!
     */
    protected it.fenealgestweb.www.PeriodTypeE localPeriodType;
     ...
     * @return it.fenealgestweb.www.FenealwebSubscriptionDTODataE
     */
    public it.fenealgestweb.www.FenealwebSubscriptionDTODataE getFenealwebSubscriptionDTOData() {
    ...
    public void setFenealwebSubscriptionDTOData(
        it.fenealgestweb.www.FenealwebSubscriptionDTODataE param) {
    ...
    /**
     * Auto generated getter method
     * @return it.fenealgestweb.www.PeriodTypeE
     */
    public it.fenealgestweb.www.PeriodTypeE getPeriodType() {
     ...
     */
    public void setPeriodType(it.fenealgestweb.www.PeriodTypeE param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localSector != null) {
            writeAttribute("http://www.fenealgestweb.it/", "Sector",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localSector), xmlWriter);
        }

        if (localContract != null) {
            writeAttribute("http://www.fenealgestweb.it/", "Contract",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localEntity != null) {
            writeAttribute("http://www.fenealgestweb.it/", "Entity",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localEntity), xmlWriter);
        }

        if (localEmployCompany != null) {
            writeAttribute("http://www.fenealgestweb.it/", "EmployCompany",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (!java.lang.Double.isNaN(localQuota)) {
            writeAttribute("http://www.fenealgestweb.it/", "Quota",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localInitialDate != null) {
            writeAttribute("http://www.fenealgestweb.it/", "InitialDate",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localYear != java.lang.Integer.MIN_VALUE) {
            writeAttribute("http://www.fenealgestweb.it/", "Year",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localYear), xmlWriter);
        }
        else {
        ...
        if (localSemester != java.lang.Integer.MIN_VALUE) {
            writeAttribute("http://www.fenealgestweb.it/", "Semester",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localPeriodType != null) {
            writeAttribute("http://www.fenealgestweb.it/", "PeriodType",
        ...
        if (localLevel != null) {
            writeAttribute("http://www.fenealgestweb.it/", "Level",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
    ...
    public static class Factory {
         ...
         */
        public static SubscriptionDTOE parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SubscriptionDTOE object = new SubscriptionDTOE();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubscriptionDTO".equals(type)) {
                            ...
                            return (SubscriptionDTOE) it.fenealgestweb.www.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribSector = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "Sector");
                ...
                java.lang.String tempAttribContract = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "Contract");
                ...
                java.lang.String tempAttribEntity = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "Entity");
                ...
                java.lang.String tempAttribEmployCompany = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "EmployCompany");
                ...
                java.lang.String tempAttribQuota = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "Quota");
                ...
                java.lang.String tempAttribInitialDate = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "InitialDate");
                ...
                java.lang.String tempAttribYear = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "Year");
                ...
                java.lang.String tempAttribSemester = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "Semester");
                ...
                java.lang.String tempAttribPeriodType = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "PeriodType");

                if (tempAttribPeriodType != null) {
                    java.lang.String content = tempAttribPeriodType;

                    object.setPeriodType(it.fenealgestweb.www.PeriodTypeE.Factory.fromString(
                ...
                java.lang.String tempAttribLevel = reader.getAttributeValue("http://www.fenealgestweb.it/",
                        "Level");
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("",
                            "FenealwebSubscriptionDTOData").equals(
                            reader.getName())) {
                    object.setFenealwebSubscriptionDTOData(it.fenealgestweb.www.FenealwebSubscriptionDTODataE.Factory.parse(
                            reader));
