...
/**
 *  DocumentDTO bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DocumentDTO implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localDocumentDate != null) {
            writeAttribute("www.fenealgestweb.it", "DocumentDate",
        ...
        if (localCity != null) {
            writeAttribute("www.fenealgestweb.it", "City",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localCity), xmlWriter);
        }
        ...
        if (localState != null) {
            writeAttribute("www.fenealgestweb.it", "State",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localState), xmlWriter);
        }

        if (localNotes != null) {
            writeAttribute("www.fenealgestweb.it", "Notes",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
    ...
    public static class Factory {
         ...
         */
        public static DocumentDTO parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            DocumentDTO object = new DocumentDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DocumentDTO".equals(type)) {
                            ...
                            return (DocumentDTO) it.fenealgestweb.www.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                java.lang.String tempAttribDocumentDate = reader.getAttributeValue("www.fenealgestweb.it",
                        "DocumentDate");
                ...
                java.lang.String tempAttribCity = reader.getAttributeValue("www.fenealgestweb.it",
                        "City");
                ...
                java.lang.String tempAttribState = reader.getAttributeValue("www.fenealgestweb.it",
                        "State");
                ...
                java.lang.String tempAttribNotes = reader.getAttributeValue("www.fenealgestweb.it",
                        "Notes");
