...
/**
 *  GetDocumentLen bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDocumentLen implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetDocumentLen", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetDocumentLen", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDocumentLen parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetDocumentLen object = new GetDocumentLen();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDocumentLen".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetDocumentLen) it.fenealgestweb.www.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
