...
public class FiscalData implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setNazione(java.lang.String param) {
        localNazioneTracker = param != null;
    ...
    public static class Factory {
        ...
        public static FiscalData parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FiscalData".equals(type)) {
                            ...
                            return (FiscalData) it.fenealgestweb.www.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.fenealgestweb.it/", "Nazione").equals(
                            reader.getName())) ||
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "Nazione" + "  cannot be null");
                    }
