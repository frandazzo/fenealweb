...
/**
 *  RenameImportExportFile bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RenameImportExportFile implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.fenealgestweb.it/",
            "RenameImportExportFile", "ns2");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RenameImportExportFile", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RenameImportExportFile", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RenameImportExportFile parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RenameImportExportFile object = new RenameImportExportFile();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RenameImportExportFile".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RenameImportExportFile) it.fenealgestweb.www.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
