...
/**
 *  GetDocument bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDocument implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static GetDocument parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDocument".equals(type)) {
                            ...
                            return (GetDocument) it.fenealgestweb.www.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
