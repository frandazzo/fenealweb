...
define([
    ...
    var RepositoryServiceFactory = core.AObject.extend({
        ...
        searchDeleghe: function(searchParams){
            var route = BASE + "accettdeleghe/report" ;
    ...
    var AccettDelegheAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            AccettDelegheAppView.super.ctor.call(this, formService);
            ...
            self.formView.on("submit", function(){
                ...
                svc.on("load", function(response){
                    ...
                    // aggiungo tasto ACCETTA DELEGHE
                    if ($(".accept-del").length == 0) {

                        var delAccept = '<div class="col-md-12 col-xs-3 margin-bottom-10 p0" data-toggle="tooltip" data-placement="top" title="Accetta deleghe">' +
                            '<button type="button" class="btn btn-primary full-width accept-del">' +
                            '<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>' +
                            '</button></div>';

                        $(".toolbox-buttons-cnt").append($(delAccept));
                        $(".accept-del").parent().tooltip();
                        $(".accept-del").click(function() {
                            ...
                            var container = $('<div class="accept-del-container"></div>');

                            var path = BASE + "deleghe/accetta";
                    ...
                    var reportResultsConfigurer = new resultsConfigurer.ReportUiConfigurer(grid, "accetta deleghe", false);
    ...
    exports.AccettDelegheAppView = AccettDelegheAppView;
