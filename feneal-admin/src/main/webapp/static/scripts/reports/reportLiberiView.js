...
define([
    ...
    var RepositoryServiceFactory = core.AObject.extend({
        ...
        searchLibericfCompleto: function(searchParams){
            var route = BASE + "importlibericfcompleto" ;
    ...
    var ReportLibericfAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            ReportLibericfAppView.super.ctor.call(this, formService);
            ...
            self.formView.on("load", function(){
                ...
                var templateUrl = BASE + "libericftemplate"
        ...
        getBreadcrumbItems: function() {
            ...
            return [
                ...
                {
                    label: "Report non iscritti per codice fiscale"
    ...
    var ReportLibericfcreAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            ReportLibericfcreAppView.super.ctor.call(this, formService);
            this.geoUtils = new geoUtils.GeoUtils();
        ...
        getBreadcrumbItems: function() {
            ...
            return [
                ...
                {
                    label: "Report non iscritti per codice fiscale cremona"
                    //href: ui.Navigation.instance().navigateUrl("editworker", "index", {})
                }
            ];
        },
    ...
    var ReportLibericfCompleteAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            ReportLibericfCompleteAppView.super.ctor.call(this, formService);
            this.geoUtils = new geoUtils.GeoUtils();
            ...
            self.formView.on("submit", function(){
                ...
                var factory = new RepositoryServiceFactory();
                var svc = factory.searchLibericfCompleto(data);
    ...
    var ReportLiberiBolAppView = fviews.FormAppView.extend({
        ...
        filterData : function(ente, year, infoSelect){
            ...
            $.each(self.listOfLiberi, function(index, elem){
                ...
                if (infoSelect ==  1) {
                    ...
                    $.each(elem.iscrizioni, function (index1, elem1) {
                        ...
                        var foundEnte = true;
                        if (ente) {
                            if (elem1.nomeProvincia != ente) {
                                foundEnte = false;
                            }
                        }

                        if (foundAnno && foundEnte) {
                            filterdList.push(elem);
                            return false;
                        }
            ...
            if (infoSelect)
                ...
                //se arrivo qui vuol dire che devo richiedere le info ma devo accertarmi che ci sia un filtro sulle province
                if (!ente){
                    alert("Selezionare un filtro sull' Ente");
                    self.initGrid(filterdList);
                    return;
                }
                if (filterdList.length == 0){
        ...
        getBreadcrumbItems: function() {
            ...
            return [
                ...
                {
                    label: "Report non iscritti Bolzano"
                    //href: ui.Navigation.instance().navigateUrl("editworker", "index", {})
                }
            ];
        },
    ...
    exports.ReportLiberiBolAppView = ReportLiberiBolAppView;
    exports.ReportLiberiAppView = ReportLiberiAppView;
    exports.ReportLiberiNewAppView = ReportLiberiNewAppView;
    exports.ReportLibericfAppView = ReportLibericfAppView;
    exports.ReportLibericfcreAppView = ReportLibericfcreAppView;
    exports.ReportLibericfCompleteAppView = ReportLibericfCompleteAppView;
