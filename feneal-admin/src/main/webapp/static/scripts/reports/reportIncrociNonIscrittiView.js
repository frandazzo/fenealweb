...
define([
    ...
    var RepositoryServiceFactory = core.AObject.extend({
        ...
        searchIscritti: function(searchParams){
            var route = BASE + "report/incrocio/noniscritti";
    ...
    var ReportIncrociNonIscrittiAppView = fviews.FormAppView.extend({
        ctor: function(formService) {
            ReportIncrociNonIscrittiAppView.super.ctor.call(this, formService);
        ...
        initGrid : function(responseData){
            ...
            var grid = $('#reportContainer').dxDataGrid({
                ...
                columns:[
                    ...
                    { dataField:"dataNascita",dataType:'date',visible : true},
                    ...
                    { dataField:"currentAzienda", caption: "Azienda",visible : true},
                    { dataField:"iscrittoA", visible : true},
    ...
    exports.ReportIncrociNonIscrittiAppView = ReportIncrociNonIscrittiAppView;
