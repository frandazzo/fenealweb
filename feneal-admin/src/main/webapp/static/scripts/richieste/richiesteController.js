...
define([
    ...
    "richieste/richiesteView"], function(core, fmodel, fviews, fcontrollers, views) {
    ...
    var RichiesteController = fcontrollers.Controller.extend({
        ctor: function(){
            RichiesteController.super.ctor.call(this);
        ...
        createGridView: function(params) {
            return new views.RichiesteCrudGridAppView(this.gridService, params.workerId);
        },
        ...
        createFormView: function(params) {
            ...
            if(params.dialog == 1) {
                ...
                view = new views.RichiesteCrudFormAppView(this.formService, requestId, workerId);
    ...
    exports.RichiesteController = RichiesteController;
    return exports;
});
