...
public class DelegaLavoratore {
    ...
    public void setCausaleAnnullamento(String causaleAnnullamento) {
        this.causaleAnnullamento = causaleAnnullamento;
    }
    ...
    public void setRevokeData(String revokeData) {
        this.revokeData = revokeData;
    }

    public String getRevokeData() {
        return revokeData;
    }
