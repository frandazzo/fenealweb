...
@Component
public class ImportDelegheMilanoFileFieldRenderer extends VelocityFormFieldRenderer {


    public static final String DEFAULT_ACTION = "upload/file";

    public ImportDelegheMilanoFileFieldRenderer() {
    }
    ...
    public String getPath() {
        ...
        String folderName = "importMilanoDeleghe";
