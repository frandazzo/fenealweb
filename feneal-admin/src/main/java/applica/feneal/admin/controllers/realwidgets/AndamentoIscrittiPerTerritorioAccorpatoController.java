 ...
 */
@Controller
@RequestMapping("widget/real/andamentoIscrittiPerTerritorioAccorpato")
public class AndamentoIscrittiPerTerritorioAccorpatoController {
    ...
    public String circulars(Model model) throws Exception {
        ...
        String url = "widget/real/andamentoIscrittiPerTerritorioAccorpato/";
        ...
        return "widget/real/andamentoIscrittiPerTerritorioAccorpato";
    ...
    SimpleResponse getData() {
        ...
        return new ValueResponse(widgetFacade.getAndamentoIscrittiPerTerritorioAccorpato());
