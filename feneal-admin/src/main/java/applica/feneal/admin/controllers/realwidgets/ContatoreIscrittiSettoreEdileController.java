 ...
 */
@Controller
@RequestMapping("widget/real/contatoreIscrittiEdile")
public class ContatoreIscrittiSettoreEdileController {
    ...
    public String circulars(Model model) throws Exception {
        ...
        return "widget/real/contatoreIscrittiSettoreEdile";
    ...
    SimpleResponse getData() {
        ...
        return new ValueResponse(widgetFacade.getContatoreIscrittiPerSettoreEdile());
