 ...
 */
@Controller
@RequestMapping("widget/real/andamentoIscrittiPerProvincia")
public class AndamentoIscrittiPerProvinciaController {
    ...
    public String circulars(Model model) throws Exception {
        ...
        return "widget/real/andamentoIscrittiPerProvincia";
    ...
    SimpleResponse getData() {
        ...
        return new ValueResponse(widgetFacade.getAndamentoIscrittiPerProvincia());
    ...
    SimpleResponse getData1(@RequestParam(required=false) String province) {
        ...
        return new ValueResponse(widgetFacade.getAndamentoIscrittiPerProvincia(province));
