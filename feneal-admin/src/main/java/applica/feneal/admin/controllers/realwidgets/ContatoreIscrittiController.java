 ...
 */
@Controller
@RequestMapping("widget/real/contatoreIscritti")
public class ContatoreIscrittiController {
    ...
    public String circulars(Model model) throws Exception {
        ...
        return "widget/real/contatoreIscritti";
    ...
    SimpleResponse getData() {
        ...
        return new ValueResponse(widgetFacade.getContatoreIscritti());
